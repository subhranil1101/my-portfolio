...
const SkillCard = (props: any) => {
      return (
            <div data-aos="fade-down" data-aos-duration="500" className='w-[45%]  shadow-[0_0_10px_0_#64FFDA50] hover:scale-105 cursor-pointer border-2 border-primaryColor p-2 rounded-lg font-mono'>
