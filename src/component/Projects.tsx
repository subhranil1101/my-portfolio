...
const Projects = () => {
  return (
    <div className=" 2xl-mx:px-20 2xl-mx:mx-auto 2xl-mx:ml-5 2xl-mx:place-self-auto md-mx: md-mx:px-14 md-mx:mr-5 sm-mx:pl-4 sm-mx:pr-3 sm-mx:mx-14  lg-mx:pl-10 bs-mx:pl-7 lg-mx:pr-12 ml-16 lg-mx:ml-12 bs-mx:ml-8  my-6 font-mono" id="Projects">
