                  ...
                  <Modal.Root size={modalSize} opened={props.opened} onClose={props.close}>
                        ...
                        <Modal.Content className="!rounded-xl font-mono">
                              ...
                              <Modal.Body className="!bg-bgColor !border-2  !border-primaryColor !rounded-bl-xl !rounded-br-xl !border-t-0">
                                    <Document file="Resume_Subhranil Das.pdf">
                                          {/* <Page className='flex justify-center content ' canvasBackground="transparent" scale={myScale} pageNumber={1} renderTextLayer={false} renderAnnotationLayer={false} /> */}

                                          <Page
                                className='flex justify-center content'
                            ...
                            />
                            <Page
                                className='flex justify-center content mt-4' // Added spacing between pages
                                canvasBackground="transparent"
                                scale={myScale}
                                pageNumber={2}
                                renderTextLayer={false}
